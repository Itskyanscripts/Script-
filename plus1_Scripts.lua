-- +1 Scripts Hub
-- Game | Game List | Misc
-- Mobile + PC friendly size • Default: +1 Hacker theme
...
-- ========== MAIN FRAME (smaller for mobile + PC) ==========
local Main = Instance.new("Frame")
Main.Name = "Main"
Main.Size = UDim2.new(0, 340, 0, 310)
Main.Position = UDim2.new(0.5, -170, 0.5, -155)
Main.BackgroundColor3 = Color3.fromRGB(8, 18, 12) -- +1 Hacker green
...
FeaturesFrame.CanvasSize = UDim2.new(0, 0, 0, 280)
...
local SupportedGames = {
	{
		PlaceId = 75626443136851,
		Name = "World 1 & World 2 Game",
		Desc = "Auto Farm Wins + TPs",
	},
}
...
local function createGameEntry(data)
	...
	descLabel.Text = data.Desc .. "  •  " .. tostring(data.PlaceId)
	descLabel.TextColor3 = Color3.fromRGB(100, 150, 115)
...
if SUPPORTED_PLACEIDS[game.PlaceId] then
