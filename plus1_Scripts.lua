...
-- Safe executor helpers (prevents "attempt to call a nil value")
...
-- replace getgenv() usages with safe table access pattern via local env
...
UIStroke.Color = Color3.fromRGB(0, 255, 80) -- super green
		...
		if #list == 0 then
			...
			for i, req in ipairs(list) do
				...
				btn.MouseButton1Click:Connect(function()
					pcall(playClick)
					pcall(function()
						if type(setclipboard) == "function" then setclipboard(req.msg) end
					end)
					t2.Text = "Copied!"
					task.wait(0.6)
					t2.Text = "from " .. req.user
...
CopyBtn.MouseButton1Click:Connect(function()
	if earnedKey then
		pcall(function() if type(setclipboard) == "function" then setclipboard(earnedKey) end end)
		playClick()
		CopyBtn.Text = "Copied!"
		task.wait(0.8)
		CopyBtn.Text = "Copy Key"
