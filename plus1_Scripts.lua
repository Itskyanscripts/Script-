...
local function buildGame3Features()
	...
	-- Open button (opens/hatches the selected egg)
	local openBtn = Instance.new("TextButton")
	openBtn.Size = UDim2.new(1, 0, 0, 32)
	openBtn.Position = UDim2.new(0, 0, 0, 272)
	openBtn.BackgroundColor3 = Color3.fromRGB(20, 70, 50)
	openBtn.Text = "Open"
	openBtn.TextColor3 = Color3.fromRGB(200, 255, 210)
	openBtn.Font = Enum.Font.GothamMedium
	openBtn.TextSize = 13
	openBtn.Parent = FeaturesFrame

	local openCorner = Instance.new("UICorner")
	openCorner.CornerRadius = UDim.new(0, 6)
	openCorner.Parent = openBtn

	-- Keep Buy + Open buttons below dropdown when open
	local function updateEggBtnsPos()
		if dropList.Visible then
			local offset = 234 + #eggOptions * 30
			buyBtn.Position = UDim2.new(0, 0, 0, offset)
			openBtn.Position = UDim2.new(0, 0, 0, offset + 38)
		else
			buyBtn.Position = UDim2.new(0, 0, 0, 234)
			openBtn.Position = UDim2.new(0, 0, 0, 272)
		end
