...
-- Sounds (ASMR keyboard, wrong, find, level, unlock, WIN, expire)
-- Soft mechanical keyboard / ASMR style clicks
local clicks = {
	"rbxassetid://6895079853",  -- soft click
	"rbxassetid://6895079281",
	"rbxassetid://10066927508", -- key tap
	"rbxassetid://911382214",
	"rbxassetid://515373460",
}
...
local expires = {"rbxassetid://138081500","rbxassetid://178077629","rbxassetid://12222124"}

local function playSfx(ids, vol, speed)
	local s = Instance.new("Sound")
	s.SoundId = ids[math.random(1,#ids)]
	s.Volume = vol or 0.45
	s.PlaybackSpeed = speed or (0.95 + math.random()*0.15)
	s.Parent = SoundService
	s:Play()
	s.Ended:Connect(function() s:Destroy() end)
	task.delay(4, function() if s and s.Parent then s:Destroy() end end)
end
local function playClick() playSfx(clicks, 0.35, 1.05 + math.random()*0.1) end
...
local function playExpire() playSfx(expires, 0.6, 0.75) end
...
RequestBox.Text = ""
RequestBox.PlaceholderText = "e.g. My Game or 123456789"
...
mkL(KeyPage, "Enter your key below.\nEarned keys expire in 10 minutes • Special key always works", 46, 11, Color3.fromRGB(150,150,150), false)
