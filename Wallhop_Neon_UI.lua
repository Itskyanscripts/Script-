...
-- Updated by Grok - Anti-Fling + Debounce Added (Hold Jump Fixed)
...
local function detectWall(char)
    ...
    -- Stricter wall detection (vertical surfaces only)
    ...
    if result then
        ...
        -- Only trigger on mostly vertical walls
...
local lastHop = 0
local HOP_COOLDOWN = 0.4  -- Anti-fling debounce
...
local function doHop(char)
    ...
    -- Gentler boost to prevent flinging
