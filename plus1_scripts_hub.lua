...
local SESSION_MAX = 20 * 60 -- 20:00
local ICON_NORMAL = "rbxthumb://type=Asset&id=78901068522402&w=420&h=420"
local ICON_WARN = "rbxthumb://type=Asset&id=89042512685010&w=420&h=420" -- alarm plus <=10:00
local ICON_OFF = "rbxthumb://type=Asset&id=90057204200047&w=420&h=420" -- alarm off at 0

-- Valid keys (add more here)
-- duration is ignored for session; session always 20 min after unlock
local VALID_KEYS = {
	["1mth3b3st"] = true,
	["f0rfàn0nl6"] = true,
	["plus1owner"] = true,
...
keyHint.Text = "Session lasts 20:00 after unlock"
...
-- Get Key panel (timer + info + discord)
local GetKeyPanel = Instance.new("Frame")
GetKeyPanel.Name = "GetKeyPanel"
GetKeyPanel.Size = UDim2.new(0, 311, 0, 190)
GetKeyPanel.Position = UDim2.new(0.5, -155, 0.5, -95)
GetKeyPanel.BackgroundColor3 = Color3.fromRGB(74, 68, 145)
GetKeyPanel.BorderSizePixel = 0
GetKeyPanel.Visible = false
GetKeyPanel.ZIndex = 70
GetKeyPanel.Parent = ScreenGui
Instance.new("UICorner", GetKeyPanel).CornerRadius = UDim.new(0, 8)

local gkTitle = Instance.new("Frame")
gkTitle.Size = UDim2.new(1, 0, 0, 30)
gkTitle.BackgroundColor3 = Color3.fromRGB(74, 68, 145)
gkTitle.BorderSizePixel = 0
gkTitle.ZIndex = 71
gkTitle.Parent = GetKeyPanel
Instance.new("UICorner", gkTitle).CornerRadius = UDim.new(0, 8)

local gkTitleText = Instance.new("TextLabel")
gkTitleText.Size = UDim2.new(0, 160, 1, 0)
gkTitleText.Position = UDim2.new(0, 8, 0, 0)
gkTitleText.BackgroundTransparency = 1
gkTitleText.Text = "Get Key"
gkTitleText.TextColor3 = Color3.fromRGB(255, 255, 255)
gkTitleText.TextSize = 14
gkTitleText.Font = Enum.Font.GothamBold
gkTitleText.TextXAlignment = Enum.TextXAlignment.Left
gkTitleText.ZIndex = 72
gkTitleText.Parent = gkTitle

local gkTimerIcon = Instance.new("ImageLabel")
gkTimerIcon.Size = UDim2.new(0, 18, 0, 18)
gkTimerIcon.Position = UDim2.new(0, 100, 0.5, -9)
gkTimerIcon.BackgroundTransparency = 1
gkTimerIcon.Image = "rbxthumb://type=Asset&id=78901068522402&w=420&h=420"
gkTimerIcon.ZIndex = 72
gkTimerIcon.Parent = gkTitle

local gkTimerLabel = Instance.new("TextLabel")
gkTimerLabel.Size = UDim2.new(0, 42, 1, 0)
gkTimerLabel.Position = UDim2.new(0, 120, 0, 0)
gkTimerLabel.BackgroundTransparency = 1
gkTimerLabel.Text = "20:00"
gkTimerLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
gkTimerLabel.TextSize = 11
gkTimerLabel.Font = Enum.Font.GothamBold
gkTimerLabel.ZIndex = 72
gkTimerLabel.Parent = gkTitle

local gkClose = Instance.new("TextButton")
gkClose.Size = UDim2.new(0, 50, 1, 0)
gkClose.Position = UDim2.new(1, -55, 0, 0)
gkClose.BackgroundTransparency = 1
gkClose.Text = "Close"
gkClose.TextColor3 = Color3.fromRGB(255, 255, 255)
gkClose.TextSize = 11
gkClose.Font = Enum.Font.GothamBold
gkClose.ZIndex = 72
gkClose.Parent = gkTitle
...
secA.ZIndex = 71
secA.Parent = GetKeyPanel
Instance.new("UICorner", secA).CornerRadius = UDim.new(0, 8)
local saStroke = Instance.new("UIStroke", secA)
saStroke.Color = Color3.fromRGB(87, 92, 154)
saStroke.Thickness = 2

local secATitle = Instance.new("TextLabel")
secATitle.Size = UDim2.new(1, -8, 0, 20)
secATitle.Position = UDim2.new(0, 4, 0, 6)
secATitle.BackgroundTransparency = 1
secATitle.Text = "How to get"
secATitle.TextColor3 = Color3.fromRGB(200, 190, 255)
secATitle.TextSize = 12
secATitle.Font = Enum.Font.GothamBold
secATitle.ZIndex = 72
secATitle.Parent = secA
...
secB.ZIndex = 71
secB.Parent = GetKeyPanel
Instance.new("UICorner", secB).CornerRadius = UDim.new(0, 8)
local sbStroke = Instance.new("UIStroke", secB)
sbStroke.Color = Color3.fromRGB(87, 92, 154)
sbStroke.Thickness = 2

local secBTitle = Instance.new("TextLabel")
secBTitle.Size = UDim2.new(1, -8, 0, 20)
secBTitle.Position = UDim2.new(0, 4, 0, 6)
secBTitle.BackgroundTransparency = 1
secBTitle.Text = "Discord"
secBTitle.TextColor3 = Color3.fromRGB(200, 190, 255)
secBTitle.TextSize = 12
secBTitle.Font = Enum.Font.GothamBold
secBTitle.ZIndex = 72
secBTitle.Parent = secB

local copyDisc = Instance.new("TextButton")
copyDisc.Size = UDim2.new(1, -12, 0, 32)
copyDisc.Position = UDim2.new(0, 6, 0, 40)
copyDisc.BackgroundColor3 = Color3.fromRGB(100, 60, 160)
copyDisc.Text = "Copy Invite"
copyDisc.TextColor3 = Color3.fromRGB(255, 255, 255)
copyDisc.TextSize = 12
copyDisc.Font = Enum.Font.GothamBold
copyDisc.ZIndex = 72
copyDisc.Parent = secB
Instance.new("UICorner", copyDisc).CornerRadius = UDim.new(0, 8)

local backKey = Instance.new("TextButton")
backKey.Size = UDim2.new(1, -12, 0, 32)
backKey.Position = UDim2.new(0, 6, 0, 84)
backKey.BackgroundColor3 = Color3.fromRGB(45, 30, 80)
backKey.Text = "Back to Key"
backKey.TextColor3 = Color3.fromRGB(200, 180, 255)
backKey.TextSize = 12
backKey.Font = Enum.Font.GothamBold
backKey.ZIndex = 72
backKey.Parent = secB
Instance.new("UICorner", backKey).CornerRadius = UDim.new(0, 8)

makeDraggable(gkTitle, GetKeyPanel)
...
local function closeKeySystem()
	...
	GetKeyPanel.Visible = false
	-- only show Open Key if not unlocked yet
...
getKeyBtn.MouseButton1Click:Connect(function()
	playClick()
	-- open Get Key panel (timer + discord + info)
	KeyFrame.Visible = false
	GetKeyPanel.Visible = true
	gkTimerLabel.Text = keyTimerLabel.Text
	gkTimerIcon.Image = keyTimerIcon.Image
end)

gkClose.MouseButton1Click:Connect(function()
	playClick()
	GetKeyPanel.Visible = false
	KeyFrame.Visible = true
end)
...
copyDisc.MouseButton1Click:Connect(function()
	playClick()
	pcall(function()
		if setclipboard then setclipboard("https://discord.gg/DvhPapJNm")
		elseif toclipboard then toclipboard("https://discord.gg/DvhPapJNm") end
	end)
	copyDisc.Text = "Copied!"
	task.delay(1.2, function()
		if copyDisc then copyDisc.Text = "Copy Invite" end
	end)
end)
...
local function updateTimerIcon()
	...
	gkTimerIcon.Image = img
	gkTimerLabel.TextColor3 = col
end
...
local function startSessionTimer(fromSeconds)
	...
	gkTimerLabel.Text = formatTime(sessionLeft)
...
local function unlockHub(keyStr)
	...
	Main.Visible = true
	OpenBtn.Visible = false
	saveKeySaved(keyStr or "session", os.time() + SESSION_MAX)
	startSessionTimer(SESSION_MAX)
	playClick()
end
