...
-- Reset lives on Key System only (not main GUI)
local keyResetBtn = Instance.new("TextButton")
keyResetBtn.Size = UDim2.new(0, 50, 0, 22)
keyResetBtn.Position = UDim2.new(1, -110, 0, 55)
keyResetBtn.BackgroundColor3 = Color3.fromRGB(60, 40, 80)
keyResetBtn.Text = "Reset"
keyResetBtn.TextColor3 = Color3.fromRGB(255, 220, 180)
keyResetBtn.TextSize = 11
keyResetBtn.Font = Enum.Font.GothamBold
keyResetBtn.ZIndex = 53
keyResetBtn.Parent = KeyFrame
Instance.new("UICorner", keyResetBtn).CornerRadius = UDim.new(0, 6)
